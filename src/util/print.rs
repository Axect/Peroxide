...
impl Printable for Vec<Vec<usize>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<u8>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<u16>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<u32>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<u64>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<isize>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<i8>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<i16>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<i32>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<i64>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<char>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<&str>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<String>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}

impl Printable for Vec<Vec<bool>> {
    fn print(&self) {
        println!("{:?}", self);
    }
}
...
impl Printable for Vec<Vec<f32>> {
    fn print(&self) {
        if self.is_empty() {
            println!("[]");
            return;
        ...
        for i in 0..self.len() {
            result.push_str("  ");
            result.push_str(&format_float_vec!(self[i]));
            if i != self.len() - 1 {
                result.push_str(",\n");
            } else {
                result.push_str("\n");
...
impl Printable for Vec<Vec<f64>> {
    fn print(&self) {
        if self.is_empty() {
            println!("[]");
            return;
