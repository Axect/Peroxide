...
#[no_mangle]
pub extern "C" fn ad_display(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_from(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
        for j in 1 .. i {
...
#[no_mangle]
pub extern "C" fn ad_iter_def(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_into_iter(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_iter(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_from_iter(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_double_ended_iter(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_exact_size_iter(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_index(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_neg(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_add(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
        for j in 1 .. i {
            let mut body = "".to_string();
...
#[no_mangle]
pub extern "C" fn ad_impl_sub(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
        for j in 1 .. i {
            let mut body = "".to_string();
...
#[no_mangle]
pub extern "C" fn ad_impl_mul(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
        for j in 1 .. i+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_div(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
        // i >= j (self >= rhs)
        for j in 1 .. i+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_explogops(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_powops(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_trigops(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn def_ad(_item: TokenStream) -> TokenStream {
...
#[no_mangle]
pub extern "C" fn ad_impl_ad(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_from_type(item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_add_f64(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_sub_f64(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_mul_f64(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_div_f64(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn f64_impl_add_ad(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn f64_impl_sub_ad(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn f64_impl_mul_ad(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn f64_impl_div_ad(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn f64_impl_from_ad(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 1 .. N+1 {
...
#[no_mangle]
pub extern "C" fn ad_impl_stable_fn(_item: TokenStream) -> TokenStream {
    let mut total = "".to_string();
    for i in 2 .. N+1 {
        for j in 2 .. (i+1) {
